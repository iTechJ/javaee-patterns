...
public class MongoEntity2DAOImpl implements Entity2DAO {

    @Override
    public void save(DbEntity2 entity) {
        //Save DB record using specific MongoDB API
    }

    @Override
    public void update(DbEntity2 entity) {
        //Update DB record  using specific MongoDB API
    }

    @Override
    public void delete(DbEntity2 entity) {
        //Delete DB record  using specific MongoDB API
    }

    @Override
    public DbEntity2 findBySomeCriteria() {
        // Find entity by criteria using specific MongoDB API
